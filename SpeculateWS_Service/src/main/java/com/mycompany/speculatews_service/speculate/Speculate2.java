...
//		Jogador j2 = new Jogador(nomeJogador2, idJ2, 15);
    ...
    public int temPartida(int idJogador) {
        ...
        /*
		 * -1 ERRO 0 NAO HA PARTIDA 1 HA PARTIDA E � O JOGADOR QUE INICIA 2 HA PARTIDA E
		 * � O SEGUNDO JOGADOR QUE INICIA
		 * 
         */
    }
...
//                    }
        ...
        return -2; // jogador nao encontrado
